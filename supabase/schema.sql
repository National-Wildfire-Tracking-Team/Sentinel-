...
-- ─── 4b. Storage bucket for reporter-uploaded incident photos ─────────────────
-- Public bucket: incident_updates are already publicly readable (see
-- "updates public read" policy above), so photos attached to them should be
-- too. Uploads are restricted to authenticated reporters/admins writing into
